...
namespace Switch.Infra.Data.Mappings
{
    public class UserMap : IEntityTypeConfiguration<User>
    {
        public void Configure(EntityTypeBuilder<User> builder)
        {
            ...
            builder.Property(c => c.FirstName).HasColumnType("varchar(60)").IsRequired();
            builder.Property(c => c.LastName).HasColumnType("varchar(60)").IsRequired();
            ...
            builder.HasOne(x => x.Identification).WithOne(x => x.User).HasForeignKey<Identification>(x => x.UserId);
